...
import cv2
from postprocessing import get_model_output_by_index, letterbox, focus_process, resize_image, detect, non_max_suppression, scale_coords
...
#         print("img_dev_ptr, img_buf_size: ", img_dev_ptr, img_buf_size)
        ...
        for idx, feat, tgt_shape in zip(range(3), feature_maps, yolo_shape):
            feature_maps[idx] = feat.reshape(tgt_shape).transpose((0, 1, 3, 4, 2))
            
        res_tensor = detect(feature_maps)
