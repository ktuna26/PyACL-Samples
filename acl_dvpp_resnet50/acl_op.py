...
from constant import ACL_MEM_MALLOC_NORMAL_ONLY, \
    ...
    PIXEL_FORMAT_YUV_SEMIPLANAR_420, ACL_FORMAT_ND,\
    ACL_FLOAT, ACL_FLOAT16, ACL_INT32, NPY_UINT
...
class SingleOp():
    ...
    def init_resource_cast(self):
        ...
        print("input tensor size", acl.get_tensor_desc_size(self._input_desc))
        print("output tensor size", tensor_size)
    ...
    def _gen_input_buffer(self, dataset_ptr):
        ...
        print("input buffer tensor size", acl.get_tensor_desc_size(self.input_buffer))
    ...
    def _forward_op_arg_max_d(self):
        ret = acl.op.execute(self.op_type_name,
                             [self.input_desc_arg_max_d],
                             [self.output_buffer_cast],
                             [self.output_desc_arg_max_d],
                             [self.output_buffer_arg_max_d],
